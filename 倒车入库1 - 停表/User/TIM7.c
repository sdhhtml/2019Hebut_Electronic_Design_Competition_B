...
unsigned int Time_1=2500;//左
unsigned int Time_2=1000;//直行
unsigned int Time_3=3500;//右转
unsigned int Time_4=200;//直行
unsigned int Time_5=4250;//左转
unsigned int Time_6=4000;//右后转
unsigned int Time_7=150;//后退
		...
		if(TIM7_10us_Count>99)//1ms
		{
			...
			else//无硬币
			{
				if(JS==0)
				{
					...
					if(JS_count==1)
					{
						YB_JL=(unsigned int)CaptureNumberB2*2;
					}
					if(JS_count==4)
					{
						CD=1;
