...
extern unsigned int TB_time;//停表时间
//unsigned int Time_1=2500;//左
//unsigned int Time_2=1250;//直行
//unsigned int Time_3=3000;//右转
//unsigned int Time_4=3000;//直行
//unsigned int Time_5=3000;//左转
//unsigned int Time_6=101;//右后转
//unsigned int Time_7=101;//后退
